...
Write a function named raisedToTheThird that takes in an array of numbers and returns a new array of each of 
those numbers raised to the 3rd power (hint: look up Math.pow()). Use forEach to solve this problem.
...
const appendFirstToLast = (arr) => {
  // Solution code here...arr.push(arr[0]);
  arr.push(arr[0]);
};
